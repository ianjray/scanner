...
public:
    /// @brief Describes location in source text.
    struct Loc
    {
        size_t line;
        size_t column;
    ...
    /// @brief Assign content to be scanned.
    ...
    /// @brief Test if content is empty.
    ...
    /// @brief Match character from set.
    ...
    /// @brief Accept character matched by predicate.
